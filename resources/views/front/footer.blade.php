...
<footer class="site__footer">
    ...
    <!-- photoswipe / end -->
    <!-- scripts -->
    <script src="{{URL::TO('front/')}}/vendor/jquery/jquery.min.js"></script>
    <script src="{{URL::TO('front/')}}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{URL::TO('front/')}}/vendor/owl-carousel/owl.carousel.min.js"></script>
    <script src="{{URL::TO('front/')}}/vendor/nouislider/nouislider.min.js"></script>
    <script src="{{URL::TO('front/')}}/vendor/photoswipe/photoswipe.min.js"></script>
    <script src="{{URL::TO('front/')}}/vendor/photoswipe/photoswipe-ui-default.min.js"></script>
