...
<head>
    ...
    <link rel="icon" type="image/png" href="{{URL::TO('front/')}}/images/favicon.png">
    <!-- fonts -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i">
    <!-- css -->
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/owl-carousel/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/photoswipe/photoswipe.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/photoswipe/default-skin/default-skin.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/select2/css/select2.min.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/css/style.css">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/css/style.header-spaceship-variant-one.css" media="(min-width: 1200px)">
    <link rel="stylesheet" href="{{URL::TO('front/')}}/css/style.mobile-header-variant-one.css" media="(max-width: 1199px)">
    <!-- font - fontawesome -->
    <link rel="stylesheet" href="{{URL::TO('front/')}}/vendor/fontawesome/css/all.min.css">
</head>
                    ...
                    <div class="mobile-header__body">
                        ...
                        <a class="mobile-header__logo" href="">
                            ...
                            <svg width="130" height="20">
                                <path class="mobile-header__logo-part-one" d="M40,19.9c-0.3,0-0.7,0.1-1,0.1h-4.5c-0.8,0-1.5-0.7-1.5-1.5v-17C33,0.7,33.7,0,34.5,0H39c0.3,0,0.7,0,1,0.1c4.5,0.5,8,4.3,8,8.9v2C48,15.6,44.5,19.5,40,19.9z M44,9.5C44,6.7,41.8,4,39,4h-0.8C37.5,4,37,4.5,37,5.2v9.6
            ...
            <div class="header">
                ...
                <div class="header__topbar-start">
                    <div class="topbar topbar--spaceship-start">
                        ...
                        <div class="topbar__item-text"><a class="topbar__link" href="{{route('front_about')}}">About Us</a></div>
                        <div class="topbar__item-text"><a class="topbar__link" href="{{route('front_contact')}}">Contacts</a></div>
                            ...
                            <ul class="main-menu__list">
                                            ...
                                            <li class="menu__item menu__item--has-submenu">
                                                ...
                                                <div class="menu__submenu">
                                                    <ul class="menu">
                                                        ...
                                                        <?php
                                                            $subcatagory = $subcategory::find($value->id)->Subcatagory;
                                                        ?> 
                                                            <li class="submenu__item">
                                                                ...
                                                                @if($subcatagory != NULL)
                                                                    <div class="submenu__submenu">
                                                                        <ul class="menu">
                                                                            @foreach($subcatagory as $subvalue)
                                                                                <li class="menu__item">
                                                                                    <a href="{{route('category_details')}}" class="menu__link">
                                                                                        {{$subvalue->subcatagory_name}}
                                                                                    </a>
                                                                                </li>
                                                                            @endforeach
                                                                        </ul>
                                ...
                                <li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
                                    ...
                                    <div class="main-menu__submenu">
                                        <ul class="menu">
                                            <li class="menu__item">
                                                <a href="{{route('front_about')}}" class="menu__link">
                                                    About Us
                                                </a>
                                            </li>
                                            <li class="menu__item">
                                                <a href="{{route('front_contact')}}" class="menu__link">
                                                    Contact
                                                </a>
                                            </li>
                                            <li class="menu__item">
