                ...
                <div class="block-zone__card category-card category-card--layout--overlay">
                    <div class="category-card__body">
                        <div class="category-card__overlay-image">
                            <img srcset="<?php echo url('front'); ?>/images/categories/category-overlay-1-mobile.jpg 530w, <?php echo url('front'); ?>/images/categories/category-overlay-1.jpg 305w" src="<?php echo url('front'); ?>/images/categories/category-overlay-1.jpg" sizes="(max-width: 575px) 530px, 305px" alt="">
                        </div>
                        <div class="category-card__overlay-image category-card__overlay-image--blur">
                            <img srcset="<?php echo url('front'); ?>/images/categories/category-overlay-1-mobile.jpg 530w, images/categories/category-overlay-1.jpg 305w" src="<?php echo url('front'); ?>/images/categories/category-overlay-1.jpg" sizes="(max-width: 575px) 530px, 305px" alt="">
                        </div>
                ...
                <div class="block-zone__widget">
                    <div class="block-zone__widget-header">
                        <div class="block-zone__tabs">
                            <button class="data-btn block-zone__tabs-button block-zone__tabs-button--active" data-id="1" type="button">Featured</button>
                            <button class="data-btn block-zone__tabs-button" data-id="2" type="button">Bestsellers</button>
                            <button class="data-btn block-zone__tabs-button" data-id="3" type="button">Popular</button>
                        </div>
                    ...
                    <div class="block-zone__widget-body">
                        <div class="block-zone__carousel">
                            ...
                            <div class="owl-carousel" id="product-option-section">
                                        ...
                                        <div class="product-card__info">
                                            ...
                                            <div class="product-card__name">
                                                <div>
                                                    ...
                                                    <a href="{{route('product_details')}}">product_name</a>
                                                </div>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="rating product-card__rating-stars">
        ...
        <div class="container">
            <div class="block-banners__list">
                <a href="" class="block-banners__item block-banners__item--style--one">
                    <span class="block-banners__item-image"><img src="<?php echo url('front'); ?>/images/banners/banner1.jpg" alt=""></span>
                    <span class="block-banners__item-image block-banners__item-image--blur"><img src="<?php echo url('front'); ?>/images/banners/banner1.jpg" alt=""></span>
                ...
                <a href="" class="block-banners__item block-banners__item--style--two">
                    <span class="block-banners__item-image"><img src="<?php echo url('front'); ?>/images/banners/banner2.jpg" alt=""></span>
                    <span class="block-banners__item-image block-banners__item-image--blur"><img src="<?php echo url('front'); ?>/images/banners/banner2.jpg" alt=""></span>
